...
export default class EditNewsScreen extends React.Component {
...
//function componentDidMount membuat tangal otomatis, dia akan jalan ketika file ini di proses
 async componentDidMount(){
    ...
    componentWillMount(){
        //mengambil data data dari listNews
        const {navigation}=this.props;
        const titleNews = navigation.getParam('titleNews','titleNews');
        const descNews = navigation.getParam('descNews','descNews');
        const imageNews = navigation.getParam('imageNews','imageNews');
        this.setState({
            title:titleNews,
            desc:descNews,
            image:imageNews
    ...
    handleSubmit(){
        updateItem(this.state.title,this.state.image,this.state.desc,this.state.date);
        //yang akan muncul di form
        //lalu tika alert itu di tambahkan maka semuanya itu akan kosong jadi kaya sebelum di isi
    ...
    render(){
        return(
            ...
            <ScrollView>
                ...
                <Text style={styles.titlePage}>Update News</Text>
                ...
                <View style={styles.ButtonPickImage}>
                    ...
                    {this._maybeRenderUploadingOverlay()}
                        <View styles= {styles.ButtonAddNews}>
                            <Button
                            title = 'Add News' 
